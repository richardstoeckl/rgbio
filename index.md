...
`rgbio` provides a high-performance interface to the Rust
[gb-io](https://github.com/moshe/gb-io) crate for reading and writing
GenBank files. It is designed to be fast and memory-efficient while
providing R-friendly data structures.

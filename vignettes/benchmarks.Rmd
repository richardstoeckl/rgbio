...
To benchmark the writing, we pre-read each file once per `rgbio` format (without benchmarking), store those parsed objects, and then benchmark only the write step.
